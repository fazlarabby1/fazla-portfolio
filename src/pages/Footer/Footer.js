...
const Footer = () => {
    return (
        <div>
            <footer className="footer gap-y-5 footer-center p-6 bg-[#16162F] text-white">
                <div>
                    ...
                    <p className="font-bold">
                        <br />Trying to provide reliable and authentic services
                    </p>
                ...
                <div>
                    ...
                    <div className="grid grid-flow-col gap-4">
                        <a className='cursor-pointer transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300' href='https://github.com/fazlarabby1' target="_blank" rel="noreferrer"><BsGithub className='text-2xl text-info' /></a>
                        <a className='cursor-pointer transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300' href='https://www.linkedin.com/in/fazla-rabby-b84a39258/' target="_blank" rel="noreferrer"><ImLinkedin className='text-2xl text-info' /></a>
                        <a className='cursor-pointer transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300' href='https://www.facebook.com/fazla.rabby.3701' target="_blank" rel="noreferrer"><BsFacebook className='text-2xl text-info' /></a>
